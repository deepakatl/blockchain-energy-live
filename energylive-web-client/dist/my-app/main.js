...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http) {
        this.http = http;
        this.AUTH_URL = "http://localhost:3000/users/authenticate";
    }
...
/***/ "./src/app/_services/energy.service.ts":
/*!*********************************************!*\
  !*** ./src/app/_services/energy.service.ts ***!
  \*********************************************/
...
var EnergyService = /** @class */ (function () {
    function EnergyService(http) {
        this.http = http;
        this.AUTH_URL = "http://localhost:3000/energy/updateEnergy";
    }
    EnergyService.prototype.updateEnergy = function (energyUnit) {
        var fetchOptions = {
            method: 'POST',
            headers: {
                'Content-Type': 'application/octet-stream'
...
/*!************************************!*\
  !*** ./src/app/_services/index.ts ***!
  \************************************/
/*! exports provided: AlertService, AuthenticationService, UserService, EnergyService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _energy_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./energy.service */ "./src/app/_services/energy.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EnergyService", function() { return _energy_service__WEBPACK_IMPORTED_MODULE_3__["EnergyService"]; });
...
module.exports = "<!-- main app container -->\n<div class=\"jumbotron\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-sm-6 offset-sm-3\">\n                <alert></alert>\n                <router-outlet></router-outlet>\n            </div>\n        </div>\n    </div>\n</div>\n\n<!-- credits -->\n<div class=\"text-center\">\n    <p>\n        <a href=\"https://www.linkedin.com/in/deepak-damodaran-a5a6b0157\" target=\"_top\">Solar Energychain to provide reliable & scalable energy echo system</a>\n    </p>\n    \n</div>"
...
/* harmony import */ var _energy_energy_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./energy/energy.component */ "./src/app/energy/energy.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _energy_energy_component__WEBPACK_IMPORTED_MODULE_13__["EnergyComponent"]
            ],
            providers: [
                ...
                _services__WEBPACK_IMPORTED_MODULE_9__["EnergyService"],
...
/* harmony import */ var _energy_energy_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./energy/energy.component */ "./src/app/energy/energy.component.ts");
...
var appRoutes = [
    ...
    { path: 'energy', component: _energy_energy_component__WEBPACK_IMPORTED_MODULE_5__["EnergyComponent"] },
...
module.exports = "<h2>Solar Energy</h2>\n\n<form [formGroup]=\"energyUpdateForm\" (ngSubmit)=\"onSubmit()\">\n    \n    <div class=\"form-group\">\n        <label for=\"energyUnit\">Generated Energy</label>\n        <input type=\"text\" formControlName=\"energyUnit\" class=\"form-control\"  />\n    </div>\n    <div class=\"form-group\">\n        <button [disabled]=\"loading\" class=\"btn btn-primary\">Add Solar Energy</button>\n        <img *ngIf=\"loading\" src=\"data:image/gif;base64,\" />\n        <a [routerLink]=\"['/login']\" class=\"btn btn-link\">Logout</a>\n    </div>\n  </form> "
...
var EnergyComponent = /** @class */ (function () {
    function EnergyComponent(formBuilder, route, router, energyService) {
    ...
    EnergyComponent.prototype.ngOnInit = function () {
        this.energyUpdateForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            energyUnit: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]()
        });
        console.log(this.energyUpdateForm);
    };
    EnergyComponent.prototype.onSubmit = function () {
        var _this = this;
        console.log('energyUnit:' + this.energyUpdateForm.get('energyUnit').value);
        var loginResult = this.energyService.updateEnergy(this.energyUpdateForm.get('energyUnit').value);
        loginResult.then(function (result) {
            console.log(result + ' ' + _this.router);
    ...
    EnergyComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            ...
            _services__WEBPACK_IMPORTED_MODULE_3__["EnergyService"]])
    ], EnergyComponent);
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.loading = true;
        var loginResult = this.authenticationService.login(this.f.username.value, this.f.password.value);
        loginResult.then(function (result) {
            console.log(result + ' ' + _this.router);
            _this.router.navigate(['home']);
        });
...
module.exports = __webpack_require__(/*! /home/deepak/study/blockchain/poc/energylive-web-client/src/main.ts */"./src/main.ts");
